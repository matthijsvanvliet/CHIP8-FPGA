...
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports { i_clck }];
...
set_property -dict { PACKAGE_PIN F5    IOSTANDARD LVCMOS33 } [get_ports { o_oled_sda }]; #IO_0_35 Sch=ck_a[0]
set_property -dict { PACKAGE_PIN D8    IOSTANDARD LVCMOS33 } [get_ports { o_oled_scl }]; #IO_L4P_T0_35 Sch=ck_a[1]
set_property -dict { PACKAGE_PIN C7    IOSTANDARD LVCMOS33 } [get_ports { o_oled_vcc }]; #IO_L4N_T0_35 Sch=ck_a[2]
set_property -dict { PACKAGE_PIN E7    IOSTANDARD LVCMOS33 } [get_ports { o_oled_gnd }]; #IO_L6P_T0_35 Sch=ck_a[3]
